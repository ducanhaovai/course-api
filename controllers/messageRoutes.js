...
exports.postRoom = async (req, res) => {
  try {
    ...
    if (!name || !members || members.length === 0) {
      console.warn("POST /rooms - Invalid data provided:", req.body);
    ...
    console.error("POST /rooms - Error in creating room:", error.message);
...
exports.postMessage = async (req, res) => {
  try {
    ...
    console.error("POST /messages - Failed to send message:", error.message);
